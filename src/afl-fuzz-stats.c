...
void maybe_update_plot_file(afl_state_t *afl, u32 t_bytes, double bitmap_cvg,
  ...
  fprintf(afl->fsrv.plot_file,
          "%llu, %llu, %u, %u, %u, %u, %u, %0.02f%%, %llu, %llu, %u, %0.02f, %llu, "
          "%u\n",
          (get_cur_time() - afl->start_time) / 1000, afl->queue_cycle - 1, afl->current_entry,
          afl->queued_paths, afl->covered_branch, afl->pending_not_fuzzed, afl->pending_favored,
