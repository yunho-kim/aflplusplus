...
checks = [
 ...
 [b"remember_Ktype"],
 [b"memcpy (p->p, s, n)"],
 [b"cp-demangle.c:1596"],
 [b"d_print_comp_inner", b"recursion"],
 [b"do_type", b"typevec"],
 [b"do_type", b"recursion"],
]
...
tcs = glob.glob("/home/cheong/results/{}/1/queue/*".format(outdir)) + \
  glob.glob("/home/cheong/results/{}/1/crashes/*".format(outdir))
...
plot_file = open("/home/cheong/results/{}/1/plot_data".format(outdir), "r")
plot_file.readline()
